...
/**
 * Verifies the generated RFQ service proto messages, enums, oneof semantics, and service
 * descriptor.
 */
...
class RfqProtoTest {
        ...
        void shouldSupportAcceptedQuote() {
            var details =
                    RFQDetails.newBuilder()
                            ...
                            .setAcceptedQuote(
                                    Quote.newBuilder().setQuoteId("q-1").setLpId("lp-citi"))
    ...
    class ListRfqsTests {
        ...
        void shouldBuildFilteredRequest() {
            var req =
                    ListRFQsRequest.newBuilder()
                            .setTenant(TenantContext.newBuilder().setTenantId("acme-corp"))
                            .setPagination(
                                    PaginationRequest.newBuilder().setPage(1).setPageSize(25))
                            .setInstrumentId("EUR/USD")
            ...
            assertThat(req.getStatusesList())
                    .containsExactly(RFQStatus.RFQ_STATUS_QUOTING, RFQStatus.RFQ_STATUS_CREATED);
        }
    }
                    ...
                    AcceptQuoteRequest.newBuilder()
                            ...
                            .setUser(
                                    UserContext.newBuilder()
                                            ...
                                            .setUsername("jdoe"))
                            .setCorrelation(
                                    CorrelationContext.newBuilder().setCorrelationId("corr-456"))
                            .build();

            var resp =
                    AcceptQuoteResponse.newBuilder()
                            .setSuccess(true)
        ...
        void shouldCarryExpiredUpdate() {
            var update =
                    RFQUpdate.newBuilder()
                            ...
                            .setExpired(
                                    RFQExpired.newBuilder()
                                            .setExpiredAt(
                                                    Timestamp.newBuilder()
                                                            .setSeconds(1_700_000_030L)))
                            .build();
        ...
        void shouldCarryCancelledUpdate() {
            var update =
                    RFQUpdate.newBuilder()
                            ...
                            .setCancelled(RFQCancelled.newBuilder().setReason("Market closed"))
                            .build();
