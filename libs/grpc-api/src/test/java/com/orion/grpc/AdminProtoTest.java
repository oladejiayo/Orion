...
/**
 * Verifies the generated Admin service proto messages — instrument management, kill switch, trading
 * limits, and service descriptor.
 */
...
class AdminProtoTest {
    ...
    class ServiceDescriptorTests {
        ...
        void shouldDefineSixRpcs() {
            // CreateInstrument, UpdateInstrument, GetInstrument, ListInstruments, SetKillSwitch,
            // UpdateLimits
            var descriptor = AdminServiceGrpc.getServiceDescriptor();
    ...
    class CreateInstrumentTests {
        ...
        void shouldBuildCreateRequest() {
            var req =
                    CreateInstrumentRequest.newBuilder()
                            .setSymbol("GBP/USD")
    ...
    class UpdateInstrumentTests {
        ...
        void shouldBuildPartialUpdate() {
            ...
            var req =
                    UpdateInstrumentRequest.newBuilder()
                            .setInstrumentId("inst-eurusd")
    ...
    class KillSwitchTests {
        ...
        void shouldBuildActivation() {
            var req =
                    SetKillSwitchRequest.newBuilder()
                            .setEnabled(true)
        ...
        void shouldBuildResponse() {
            var resp =
                    SetKillSwitchResponse.newBuilder()
                            .setSuccess(true)
    ...
    class UpdateLimitsTests {
        ...
        void shouldBuildPartialLimitsUpdate() {
            var req =
                    UpdateLimitsRequest.newBuilder()
                            .setUserId("trader-42")
        ...
        void shouldBuildResponse() {
            var resp =
                    UpdateLimitsResponse.newBuilder()
                            .setSuccess(true)
                            .setUserId("trader-42")
                            .build();
    ...
    class ListInstrumentsTests {
        ...
        void shouldBuildFilteredRequest() {
            var req =
                    ListInstrumentsRequest.newBuilder()
                            .setTenant(TenantContext.newBuilder().setTenantId("acme-corp"))
                            .setPagination(
