 ...
 *
 * <p>Every incoming request (HTTP, gRPC, Kafka) should establish a {@code CorrelationContext}
 * containing identifiers that enable distributed tracing and log correlation. These values are
 * propagated to downstream services via headers/metadata and injected into SLF4J MDC for automatic
