 ...
 * <p>
 * WHY a utility class: ABAC checks whether a user is entitled to trade a specific
 * asset class, instrument, venue, or notional amount. Empty sets mean "no restriction."
 */
public final class EntitlementChecker {
    ...
    /**
     * Checks if the user can trade the given asset class.
     * An empty assetClasses set in entitlements means "all allowed."
     */
    public static boolean canTradeAssetClass(Entitlements entitlements, AssetClass assetClass) {
        ...
        return entitlements.assetClasses().isEmpty() || entitlements.assetClasses().contains(assetClass);
    }

    /**
     * Checks if the user can trade the given instrument.
     * An empty instruments set means "all allowed."
     */
    public static boolean canTradeInstrument(Entitlements entitlements, String instrumentId) {
        return entitlements.instruments().isEmpty() || entitlements.instruments().contains(instrumentId);
    }

    /**
     * Checks if the user can access the given venue.
     * An empty venues set means "all allowed."
     */
